...
module.exports = {
  ...
  content: [
    ...
    "./src/**/*.{ts,tsx}" // Added from the first file
  ],
  theme: {
    extend: {
      backgroundImage: {
      ...
      boxShadow: {
        ...
        'aboutus-shadow-imgs': ' 0px 0px 100px #ccc',
        'service-main-shadow-hover': '0px 20px 30px 0px rgba(35, 94, 231, 0.2)'
      },
      fontFamily: {
        poppins: ['var(--font-poppins)'],
        WonderUnitSans: ['var(--font-workSans)'],
